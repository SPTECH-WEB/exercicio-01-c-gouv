...
public class fatura {
    ...
    @DecimalMin(value = "10.00", message = "O valor mínimo é 10.00") @DecimalMax(value = "5000.00", message = "O valor máximo é 5000.00")
    private Double valor;

    @NotNull(message = "A data de pagamento é obrigatória")
    @FutureOrPresent(message = "A data de pagamento deve ser maior ou igual a hoje")
